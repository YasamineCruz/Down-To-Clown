...
![alt text](https://github.com/yasaminecruz/API-project/blob/main/Authenticate-Me-DB-Schema-image.png?raw=true)
...
* Request
  * Method: GET
  * URL: /event?page=[]&size=[]&name=[]&type=[]&startDate=[]
  * Query Parameters
